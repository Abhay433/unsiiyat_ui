...
Tire saamne aasmaan aur bhi hain`
  ...
  readonly dictionaryWords: Record<string, { ur: string; hi: string; en: string }> = {
    'انسیت': { ur: 'محبت، دلی لگاؤ، مانوسیت، باہمی قربت', hi: 'आत्मीयता, लगाव, गहरा स्नेह, प्रेम', en: 'Intimacy, profound affection, attachment' },
    'Unsiiyat': { ur: 'محبت، دلی لگاؤ، مانوسیت', hi: 'आत्मीयता, स्नेह, अपनत्व', en: 'Profound love, affection, intimacy' },
    'उन्सीयत': { ur: 'محبت، دلی لگاؤ', hi: 'आत्मीयता, स्नेह', en: 'Affection, intimacy' },
    'خواہشیں': { ur: 'تمنائیں / آرزوئیں', hi: 'इच्छाएं / ख़्वाहिशें / अभिलाषाएं', en: 'Desires / Yearnings' },
    'Khwahishen': { ur: 'تمنائیں / آرزوئیں', hi: 'इच्छाएं / तमन्नाएं', en: 'Desires / Longings' },
    'ख़्वाहिशें': { ur: 'تمنائیں', hi: 'इच्छाएं / अरमान', en: 'Desires' },
    'ارمان': { ur: 'حسرت / دلی خواہش / آرزو', hi: 'इच्छा / अभिलाषा / तमन्ना', en: 'Longing / Heart’s desire' },
    'Armaan': { ur: 'حسرت / دلی خواہش', hi: 'तमन्ना / लालसा', en: 'Yearning / Aspiration' },
    'قاتل': { ur: 'مار ڈالنے والا محبوب / جان لیوا ادا', hi: 'क़ातिल / हत्यारा / माशूक़', en: 'Killer / Slaying beloved' },
    'Qaatil': { ur: 'مار ڈالنے والا محبوب', hi: 'क़ातिल / जानलेवा माशूक़', en: 'Lethal / Slaying beloved' },
    'گردن': { ur: 'گلا / ذمہ داری', hi: 'गला / ज़िम्मेदारी', en: 'Neck / Responsibility' },
    'چشمِ تر': { ur: 'بھیگی ہوئی آنکھ / اشکبار', hi: 'अश्रुपूरित आँख / भीगी आँख', en: 'Tearful, weeping eyes' },
    'خُلد': { ur: 'جنت / بہشت / فردوس', hi: 'स्वर्ग / जन्नत / बहिश्त', en: 'Paradise / Eternal Heaven' },
    'Khuld': { ur: 'جنت', hi: 'स्वर्ग', en: 'Paradise' },
    'آدم': { ur: 'حضرت آدم علیہ السلام / انسان', hi: 'मनुष्य / आदम', en: 'First Man / Humanity' },
    'کوچہ': { ur: 'گلی / محبوب کا محلہ', hi: 'गली / महबूब का मुहल्ला', en: 'Street / Beloved’s lane' },
    'Kooche': { ur: 'محبوب کی گلی', hi: 'गली / मुहल्ला', en: 'Beloved’s alley' },
    'کافر': { ur: 'منکر / بے رحم و سنگدل محبوب', hi: 'संगदिल महबूब / नास्तिक', en: 'Cruel beloved / Infidel' },
    'Kaafir': { ur: 'بے رحم محبوب', hi: 'पत्थरदिल माशूक़', en: 'Heartless, captivating beloved' },
    'مے خانہ': { ur: 'شراب خانہ / صوفیانہ معرفت کا مقام', hi: 'मयख़ाना / मदिरालय', en: 'Tavern / Mystical realm of wine' },
    'Maikhāna': { ur: 'شراب خانہ', hi: 'मयख़ाना / मधुशाला', en: 'Tavern / Winehouse' },
    'واعظ': { ur: 'نصیحت کرنے والا / پند گو', hi: 'उपदेशक / नसीहत देने वाला', en: 'Preacher / Moralist' },
    'Waaiz': { ur: 'نصیحت کار', hi: 'उपदेशक', en: 'Preacher' },
    'گلوں': { ur: 'پھولوں (جمع گل)', hi: 'फूलों', en: 'Flowers / Roses' },
    'نوبہار': { ur: 'نئی بہار کا موسم', hi: 'नई बसंत ऋतु', en: 'Early spring season' },
    'گلشن': { ur: 'باغ / چمن', hi: 'बाग़ / चमन', en: 'Garden / Floral meadow' },
    'قفس': { ur: 'پنجرا / قید خانہ', hi: 'पिंजरा / कारागार', en: 'Cage / Imprisonment' },
    'صبا': { ur: 'صبح کی ٹھنڈی و خوشبودار ہوا', hi: 'सुबह की शीतल मंद पवन', en: 'Morning gentle breeze' },
    'کاکل': { ur: 'محبوب کی زلفیں / گیسو', hi: 'ज़ुल्फ़ें / केश', en: 'Beloved’s curls / Tresses' },
    'مشکبار': { ur: 'کستوری کی خوشبو بکھیرنے والی', hi: 'कस्तूरी जैसी सुगंधित', en: 'Musk-scented / Fragrant' },
    'سوئے دار': { ur: 'پھانسی کے پھندے کی طرف / حق پر قربانی', hi: 'फाँसी के तख़्ते की ओर', en: 'Towards the gallows / Martyrdom' },
    'بے دلی': { ur: 'اداس پن / دل کا نہ لگنا / مایوسی', hi: 'उदासी / विरक्ति / बेदिली', en: 'Disillusionment / Heartlessness' },
    'رنجش': { ur: 'خفگی / دلی صدمہ / باہمی ناراضگی', hi: 'मनमुटाव / ख़फ़गी / नाराज़गी', en: 'Estrangement / Quiet grievance' },
    'Ranjish': { ur: 'ناراضگی / گلہ', hi: 'मनमुटाव / ग़ुस्सा', en: 'Estrangement / Resentment' },
    'مراسم': { ur: 'تعلقات / رشتے ناطے / رسم و رواج', hi: 'रिश्ते / सम्बंध / तौर-तरीक़े', en: 'Bonds / Relationships / Traditions' },
    'Maraasim': { ur: 'تعلقات', hi: 'सम्बंध / नाते', en: 'Interpersonal bonds / Relations' },
    'لذتِ گریہ': { ur: 'رونے اور آنسو بہانے کا سرور و سکون', hi: 'रोने का सुकून व आनंद', en: 'The soothing catharsis of tears' },
    'تہی': { ur: 'خالی / تہی دست', hi: 'ख़ाली / रिक्त', en: 'Empty / Destitute / Bare' },
    'قناعت': { ur: 'جو ملے اس پر راضی رہنا / صبرو شکر', hi: 'संतोष / संतुष्टि', en: 'Contentment / Frugality' },
    'Qanaat': { ur: 'صبر و رضا', hi: 'संतोष', en: 'Contentment' },
    'شاہیں': { ur: 'اقبال کا بلند پرواز و خوددار عقاب', hi: 'ऊँची उड़ान वाला बाज़ / स्वाभिमानी', en: 'The majestic soaring royal eagle / falcon' },
    'Shaheen': { ur: 'بلند پرواز عقاب', hi: 'शाहीन / बाज़', en: 'Royal falcon' },
    'خودی': { ur: 'خود داری / خود شناسی / روحانی عظمت', hi: 'आत्म-सम्मान / आत्म-बोध', en: 'Selfhood / Divine Ego / Self-consciousness' },
    'Khudi': { ur: 'خود شناسی و وقار', hi: 'स्वाभिमान / आत्मज्ञान', en: 'Self-realization / Inner sovereignty' }
  };
