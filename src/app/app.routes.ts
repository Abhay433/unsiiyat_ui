...
import { GenreDetailComponent } from './pages/genre-detail/genre-detail.component';
...
export const routes: Routes = [
  ...
  { path: 'genre/:id', component: GenreDetailComponent, title: 'Explore Genre Works - Unsiiyat' },
  { path: 'genres/:id', redirectTo: 'genre/:id' },
